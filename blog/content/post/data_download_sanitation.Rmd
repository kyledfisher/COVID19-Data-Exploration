...
### Replace NA's in our columns of interest with zeros.  It is often convenient to
do this, since NA values in R (as well as other programming languages) can have
weird or differing behavior from what you would expect (e.g. summing values in
...
operations in a single step.  In the 4 lines below we:
    ...
    3. SUMMARIZE all the obersvations (i.e. rows) for each date into a single value
