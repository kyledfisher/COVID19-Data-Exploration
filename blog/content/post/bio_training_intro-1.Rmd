...
updated daily, and is entirely contained within comma-separated-values files (.csv files).  
Many modern programming languages,including R and Python, have libraries or packages that 
